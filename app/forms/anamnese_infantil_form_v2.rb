class AnamneseInfantilFormV2 < BaseFormV2
  def initialize
    super
    @fields = [
      { 
      ...
      { 
        ...
        name: 'historico',
        column_right: [
          { name: 'historico_observacao', type: 'observation', label: 'Observação'},
        ],
        column_left: [
          {
      ...
      { 
        ...
        name: 'problemas',
        column_right: [
          { name: 'problemas_observacao', type: 'observation', label: 'Observação'},
        ],
        column_left: [
          {
      ...
      { 
        ...
        name: 'parto',
        column_right: [
          { name: 'parto_observacao', type: 'observation', label: 'Observação'},
        ],
        column_left: [
          {
      ...
      { 
        ...
        name: 'amamentacao',
        column_right: [
          { name: 'amamentacao_observacao', type: 'observation', label: 'Observação'},
        ],
        column_left: [
          {
      ...
      { 
        ...
        name: 'sono',
        column_right: [
          { name: 'sono_observacao', type: 'observation', label: 'Observação'},
        ],
        column_left: [
          {
      ...
      { 
        ...
        column_right: [
          { name: 'desenvolvimento_observacao', type: 'observation', label: 'Observação'},
        ],
        column_left: [
          {
      ...
      { 
        ...
        name: 'saude',
        column_right: [
          { name: 'saude_observacao', type: 'observation', label: 'Observação'},
        ],
        column_left: [
          {
      ...
      { 
        ...
        name: 'escola_e_lazer',
        column_right: [
          { name: 'escola_e_lazer_observacao', type: 'observation', label: 'Observação'},
        ],
        column_left: [
          {
      ...
      { 
        ...
        column_right: [
          { name: 'relacionamentos_observacao', type: 'observation', label: 'Observação'},
        ],
        column_left: [
          {
      ...
      { 
        type: 'topic',
        name: 'comportamento_crianca_adolescente',
        column_right: [
          { name: 'comportamento_crianca_adolescente_observacao', type: 'observation', label: 'Observação'},
        ],
        column_left: [
          {
